...
> **[v1.0.0-dev.9](https://github.com/Eveelogy/morphe-patches/releases/tag/v1.0.0-dev.9)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;4 patches total
<details open>
...
|----------|----------------|-----------|
| [Disable GIF SafeSearch](#disable-gif-safesearch) | Disables content filtering on Tenor GIF search in real-time. |  |
